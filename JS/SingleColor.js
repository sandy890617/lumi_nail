...
const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbzSr2NtLdqdpQ8ELPeWBEhNcphGxWXdNZo2evBVP1Kf5qbaUbzmDMgAa-mdgCZiZsR1/exec?action=getSingleColor"; 

// 2. 快取 Key 的名字：每個網頁（專區）都必須是「唯一」的！否則資料會打架。
//    例如新網頁可以改成 "marble_products_cache_v1" (暈染)
const CACHE_KEY = "single_color_products_cache_v1"; 
...
// 如果妳未來新試算表的欄位名稱「很不一樣」，才需要來這裡加關鍵字
// =========================================================================
function getCompatibleRow(product) {
    ...
    // 這裡會自動偵測欄位：只要有包含「品牌/Brand」、「色號/Color」、「名字/姓名/Name」、「圖片/路徑/Image」就能抓到
...
function openSingleColorModal(index) {
    ...
    // =========================================================================
    // 📢 【未來修改區 4】彈跳視窗內的說明文字
    // 如果不同專區的服務內容、內含保養項目不同，可以在下面這行修改文字
    // =========================================================================
